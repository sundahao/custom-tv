...
public class ImagePageIndicatorView extends LinearLayout {
    ...
    public ImagePageIndicatorView(Context context) {
        this(context, null);
    }

    public ImagePageIndicatorView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ImagePageIndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
