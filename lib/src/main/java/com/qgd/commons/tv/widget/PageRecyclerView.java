...
public class PageRecyclerView extends RecyclerView {
    ...
    private ImagePageIndicatorView mIndicatorView = null; // 指示器布局
...
//        setLayoutManager(new FullyGridLayoutManager(mContext, spanRow, FullyGridLayoutManager.HORIZONTAL, false));
//        setLayoutManager(new ExStaggeredGridLayoutManager( spanRow, ExStaggeredGridLayoutManager.HORIZONTAL));
...
//        setLayoutManager(new ExStaggeredGridLayoutManager( spanRow, ExStaggeredGridLayoutManager.HORIZONTAL));
     ...
     */
    public void setIndicator(ImagePageIndicatorView indicatorView) {
...
//
//            Log.d("PageAdapter width=", "" + itemWidth);
//            Log.d("PageAdapter height=", "" + holder.itemView.getLayoutParams().height);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if (spanColumn == 1) {
                ...
                System.out.println("spanColumn 1="+holder.itemView.getLayoutParams().width);
...
//                holder.itemView.setPadding(pageMargin, 0, pageMargin, 0);
    ...
    public interface CallBack {
        ...
        //        void onItemKey(View view,int position);
