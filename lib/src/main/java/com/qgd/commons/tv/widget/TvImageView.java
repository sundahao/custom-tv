...
public class TvImageView extends ImageView implements View.OnFocusChangeListener {
    ...
    public TvImageView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.TvImageView);

        mScaleable = a.getBoolean(R.styleable.TvImageView_scaleable, true);
        mKeyNumber = a.getString(R.styleable.TvImageView_number);
        int berderResId = a.getResourceId(R.styleable.TvImageView_borderDrawable, R.drawable.white_light);
        mBorderDrawable = getResources().getDrawable(berderResId);

        int numberColor = a.getColor(R.styleable.TvImageView_numberColor, Color.WHITE);
        mPaint.setColor(numberColor);

        borderSize=a.getDimensionPixelSize(R.styleable.TvImageView_borderSize,borderSize);
